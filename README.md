...
Nesta atividade vamos criar um montador de avatares em pixel art! Cada aluno, assim que chegar, deve assinar, a lista de presença. 
A nota do aluno será computada considerando o horário de assinatura. 
